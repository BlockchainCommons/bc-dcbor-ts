...
const dates: EncodeCorpusEntry[] = [
  ...
  // `Date::from_string` = chrono `parse_from_rfc3339`, then `%Y-%m-%d`
  // (executed on dcbor 0.25.2 / chrono 0.4.45; the harness runs each).
  e("datestr/rfc3339-microseconds", datestr("2023-12-25T10:30:45.123456Z")),
  e("datestr/rfc3339-nine-digits", datestr("2023-12-25T10:30:45.123456789Z")),
  e("datestr/rfc3339-tenth-digit-ignored", datestr("2023-12-25T10:30:45.1234567891Z")),
  e("datestr/rfc3339-zero-fraction", datestr("2023-12-25T10:30:45.000000000Z")),
  e("datestr/rfc3339-negative-fraction", datestr("1969-12-31T23:59:59.5Z")),
  e("datestr/rfc3339-leap-second", datestr("2023-12-25T10:30:60Z")),
  e("datestr/rfc3339-leap-second-fraction", datestr("2023-12-25T10:30:60.5Z")),
  e("datestr/rfc3339-space-separator", datestr("2023-12-25 10:30:45Z")),
  e("datestr/rfc3339-lowercase", datestr("2023-12-25t10:30:45z")),
  e("datestr/rfc3339-fraction-with-offset", datestr("2023-12-25T10:30:45.5+01:00")),
  e("datestr/rfc3339-negative-offset", datestr("2023-12-25T10:30:45-05:30")),
  e("datestr/rfc3339-minus-sign-offset", datestr("2023-12-25T10:30:45\u221201:00")),
  e("datestr/rfc3339-max-offset", datestr("2023-12-25T10:30:45+23:59")),
  e("datestr/rfc3339-offset-crosses-year-9999", datestr("9999-12-31T23:59:59-23:59")),
  e("datestr/rfc3339-offset-crosses-year-0", datestr("0000-01-01T00:00:00+23:59")),
  e("datestr/rfc3339-year-zero", datestr("0000-01-01T00:00:00Z")),
  e("datestr/rfc3339-leap-day", datestr("2024-02-29T00:00:00Z")),
  e("datestr/rfc3339-empty-fraction-throws", datestr("2023-12-25T10:30:45.Z")),
  e("datestr/rfc3339-comma-fraction-throws", datestr("2023-12-25T10:30:45,5Z")),
  e("datestr/rfc3339-second-61-throws", datestr("2023-12-25T10:30:61Z")),
  e("datestr/rfc3339-hour-24-throws", datestr("2023-12-25T24:00:00Z")),
  e("datestr/rfc3339-minute-60-throws", datestr("2023-12-25T10:60:00Z")),
  e("datestr/rfc3339-offset-24h-throws", datestr("2023-12-25T10:30:45+24:00")),
  e("datestr/rfc3339-offset-minute-60-throws", datestr("2023-12-25T10:30:45+01:60")),
  e("datestr/rfc3339-compact-offset-throws", datestr("2023-12-25T10:30:45+0100")),
  e("datestr/rfc3339-hour-only-offset-throws", datestr("2023-12-25T10:30:45+01")),
  e("datestr/rfc3339-trailing-space-throws", datestr("2023-12-25T10:30:45Z ")),
  e("datestr/rfc3339-leading-space-throws", datestr(" 2023-12-25T10:30:45Z")),
  e("datestr/rfc3339-short-month-throws", datestr("2023-1-25T10:30:45Z")),
  e("datestr/rfc3339-feb-29-common-year-throws", datestr("2023-02-29T00:00:00Z")),
  e("datestr/bare-date-short-fields", datestr("2023-2-8")),
  e("datestr/bare-date-leading-whitespace", datestr(" 2023-02-08")),
  e("datestr/bare-date-tab", datestr("\t2023-02-08")),
  e("datestr/bare-date-nbsp", datestr("\u00a02023-02-08")),
  e("datestr/bare-date-inner-whitespace", datestr("2023- 02- 08")),
  e("datestr/bare-date-plus-year", datestr("+2023-02-08")),
  e("datestr/bare-date-negative-year", datestr("-0001-01-01")),
  e("datestr/bare-date-five-digit-signed-year", datestr("+12023-02-08")),
  e("datestr/bare-date-year-zero-short", datestr("0-1-1")),
  e("datestr/bare-date-max", datestr("+262142-12-31")),
  e("datestr/bare-date-min", datestr("-262143-01-01")),
  e("datestr/bare-date-leap-day", datestr("2024-02-29")),
  e("datestr/bare-date-trailing-space-throws", datestr("2023-02-08 ")),
  e("datestr/bare-date-five-digit-unsigned-throws", datestr("12023-02-08")),
  e("datestr/bare-date-six-digit-unsigned-throws", datestr("262142-12-31")),
  e("datestr/bare-date-above-max-throws", datestr("+262143-01-01")),
  e("datestr/bare-date-below-min-throws", datestr("-262144-01-01")),
  e("datestr/bare-date-year-overflow-throws", datestr("+99999999999999999999-01-01")),
  e("datestr/bare-date-month-13-throws", datestr("2023-13-01")),
  e("datestr/bare-date-month-0-throws", datestr("2023-00-10")),
  e("datestr/bare-date-feb-30-throws", datestr("2023-02-30")),
  e("datestr/bare-date-feb-29-common-year-throws", datestr("2023-02-29")),
  e("datestr/bare-date-three-digit-month-throws", datestr("2023-002-08")),
  e("datestr/bare-date-trailing-dash-throws", datestr("2023-02-08-")),
  e("datestr/bare-date-dangling-t-throws", datestr("2023-02-08T")),
  e("datestr/bare-date-fullwidth-digits-throws", datestr("\uff12\uff10\uff12\uff13-02-08")),
  e("datestr/empty-throws", datestr("")),
